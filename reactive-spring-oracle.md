...
Spring Data Kay supports reactive data stores like MongoDB, Cassandra, Redis and COuchbase and introduces new reactive repository variants and templates. We've got the reactive MongoDB driver and Spring Data integration on the classpath so lets use it to manage some data. create a new entity called `Book`.
